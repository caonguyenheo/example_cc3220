...
#define SL_SSL_SRV_KEY    			"ca-priv-key.der"               //"/cert/serverkey.der"   /* Server key file ID */ "ca-priv-key.der"
#define SL_SSL_SRV_CERT  			 "ca_in_cert_store"             // "/cert/servercert.der"  /* Server certificate file ID */
